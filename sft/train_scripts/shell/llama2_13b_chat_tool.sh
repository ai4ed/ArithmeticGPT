...
output_dir="/ArithmeticGPT/sft/models/llama2_13b_chat_op_v1"
model_name_or_path="/ArithmeticGPT/sft/models/Llama2-13B-Chat/"
...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
    ...
    --tf32 True \
    --lazy_preprocess >$ROOT_DIR/logs/llama_2_13b_chat_op_v1.log
